...
/**
 * Creates a histogram based on the frequency of various pixel values appearing in a given image.
 * In specific, it shows the red, green, blue, and intensity (average of three values) components
 * of an image.
 */
public class HistogramPanel extends JPanel {
  ...
  /**
   * The paint component over-riden from JPanel so that we can show
   * the histogram instead of the paintComponent from JPanel.
   *
   * @param g the <code>Graphics</code> object to be protected.
   */
  @Override
  ...
  /**
   * Accepts a feature into the controller.
   *
   * @param c The feature to be added to the controller.
   */
