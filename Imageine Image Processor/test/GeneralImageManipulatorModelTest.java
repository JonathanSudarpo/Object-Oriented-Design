...
public class GeneralImageManipulatorModelTest {
  ...
  public void saveImageJPEG() {
    ...
    assertEquals(new Pixel(151, 151, 151), greyScaleResult[0][0]);
    assertEquals(new Pixel(177, 177, 177), greyScaleResult[0][1]);
    assertEquals(new Pixel(236, 236, 236), greyScaleResult[1][0]);
    assertEquals(new Pixel(222, 222, 222), greyScaleResult[1][1]);
  ...
  public void filterJPEGSharpen() {
    ...
    assertEquals(new Pixel(212, 182, 128), sharpenJPEGResult[0][0]);
    assertEquals(new Pixel(255, 230, 176), sharpenJPEGResult[0][1]);
    assertEquals(new Pixel(250, 220, 166), sharpenJPEGResult[1][0]);
    assertEquals(new Pixel(255, 252, 198), sharpenJPEGResult[1][1]);
  ...
  public void testTransformJPEGGreyscale() {
    ...
    assertEquals(new Pixel(87, 87, 87), greyscaleJPEGResult[0][0]);
    assertEquals(new Pixel(117, 117, 117), greyscaleJPEGResult[0][1]);
    assertEquals(new Pixel(172, 172, 172), greyscaleJPEGResult[1][0]);
    assertEquals(new Pixel(163, 163, 163), greyscaleJPEGResult[1][1]);
  ...
  public void testTransformJPEGSepia() {
    ...
    assertEquals(new Pixel(123, 107, 73), sepiaPNGResult[0][0]);
    assertEquals(new Pixel(160, 144, 110), sepiaPNGResult[0][1]);
    assertEquals(new Pixel(237, 221, 187), sepiaPNGResult[1][0]);
    assertEquals(new Pixel(227, 211, 177), sepiaPNGResult[1][1]);
  ...
  public void testHorizontalFlipJPEG() {
    ...
    assertEquals(new Pixel(171, 81, 135), horizontalFlip1[0][0]);
    assertEquals(new Pixel(177, 101, 69), horizontalFlip1[0][1]);
    assertEquals(new Pixel(162, 72, 126), horizontalFlip1[1][0]);
    assertEquals(new Pixel(228, 152, 120), horizontalFlip1[1][1]);
    ...
    assertEquals(new Pixel(171, 81, 135), horizontalFlip2[0][0]);
    assertEquals(new Pixel(177, 101, 69), horizontalFlip2[0][1]);
    assertEquals(new Pixel(162, 72, 126), horizontalFlip2[1][0]);
    assertEquals(new Pixel(228, 152, 120), horizontalFlip2[1][1]);
  ...
  public void testVerticalFlipJPEG() {
    ...
    assertEquals(new Pixel(248, 172, 140), verticalFlip1[0][0]);
    assertEquals(new Pixel(228, 152, 120), verticalFlip1[0][1]);
    assertEquals(new Pixel(144, 68, 36), verticalFlip1[1][0]);
    assertEquals(new Pixel(177, 101, 69), verticalFlip1[1][1]);
