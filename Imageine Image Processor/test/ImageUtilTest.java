...
public class ImageUtilTest {
  ...
  public void testWriteGeneralJPEG() {
    try {
      ...
      ImageUtil.writeGeneral(jpg, "test/testFiles/test.jpeg");

      for (int i = 0; i < jpg.length; i++) {
        for (int j = 0; j < jpg[0].length; j++) {
          assertEquals(jpg[i][j], jpg[i][j]);
  ...
  public void testWriteGeneralPNG() {
    try {
      Pixel[][] png = ImageUtil.readGeneral("test/testFiles/testTwo2.png");
      ImageUtil.writeGeneral(png, "test/testFiles/newDrake.png");
      Pixel[][] pngWrite = ImageUtil.readGeneral("test/testFiles/testTwo2.png");
  ...
  public void testWriteGeneralPPM() {
    try {
      ...
      ImageUtil.writeGeneral(ppm, "test/testFiles/testTwo2.ppm");
      Pixel[][] ppmWrite = ImageUtil.readGeneral("test/testFiles/testTwo2.ppm");
