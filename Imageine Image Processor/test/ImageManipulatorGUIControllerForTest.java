...
/**
 * A reconstructed {@code ImageManipulatorGUIController} used for testing.
 * In specific, it appends a different message onto the view that allows for more specific testing.
 */
public class ImageManipulatorGUIControllerForTest implements Features {

  public final EvenBetterImageManipulatorModel model;

  public final ImageManipulatorGUIView view;
   ...
   */
  public ImageManipulatorGUIControllerForTest(EvenBetterImageManipulatorModel model,
                                              MockGUIView view)
  ...
  public void loadImage(File f) {
    if (f != null) {
      try {
        ...
        this.view.refresh();
        this.view.renderMessage("Loaded the image as " + this.currentImageName);
  ...
  public void saveImage(File f) {
    if (f != null) {
      try {
        ...
        this.view.refresh();
        this.view.renderMessage("Saved the image as " + this.currentImageName);
      } catch (IOException e) {
  ...
  public void verticalFlip() {
    if (this.currentImageName != null) {
      ...
      try {
        ...
        this.view.refresh();
        this.view.renderMessage("Vertically flipped the image as " + destName);
  ...
  public void horizontalFlip() {
    if (this.currentImageName != null) {
      ...
      try {
        ...
        this.currentImageName = destName;
        this.view.refresh();
        this.view.renderMessage("Horizontally flipped the image as " + destName);
      } catch (IllegalArgumentException e) {
        this.view.renderMessage("Could not find image");
      }
  ...
  public void brighten(int increment) {
    if (this.currentImageName != null) {
      ...
      try {
        String[] dest = this.currentImageName.split("\\.");
        String fileType = dest[1];
        String destName = dest[0].concat("br").concat('.' + fileType);
        this.model.brighten(increment, this.currentImageName, destName);
        this.currentImageName = destName;
        this.view.refresh();
        this.view.renderMessage("Brightened the image by " + increment + " as " +
  ...
  public void greyscale(String component) {
    if (this.currentImageName != null) {
      ...
      try {
        ...
        this.currentImageName = destName;
        this.view.refresh();
        this.view.renderMessage("Greyscaled the image as " + destName);
      } catch (IllegalArgumentException e) {
  ...
  public void filter(String filter) {
    if (this.currentImageName != null) {
      ...
      try {
        ...
        this.currentImageName = destName;
        this.view.refresh();
        this.view.renderMessage("Applied " + filter + " to the image as " + destName);
      } catch (IllegalArgumentException e) {
        this.view.renderMessage(e.getMessage());
      }
  ...
  public void transform(String transform) {
    if (this.currentImageName != null) {
      ...
      try {
        ...
        this.currentImageName = destName;
        this.view.refresh();
        this.view.renderMessage("Applied " + transform + " to the image as " + destName);
      } catch (IllegalArgumentException e) {
        this.view.renderMessage(e.getMessage());
      }
